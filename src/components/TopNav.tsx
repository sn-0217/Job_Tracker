...
import { Archive, BarChart3, Bell, Briefcase, LogOut, Plus, Search } from "lucide-react";
...
type NavTab = {
  key: ApplicationStatus | "all" | "__archived__" | "__analytics__";
  label: string;
  count?: number;
};
